...
import { CategoriaTortaDetalleDTO, ModalInputData } from '../../../../models/categoria-torta-dto';
...
@Component({
  selector: 'app-categoria-torta-modal',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './categoria-torta-modal.component.html',
  styleUrl: './categoria-torta-modal.component.css'
})
export class CategoriaTortaModalComponent {
  // ────────────────────────────────────────────────────────────────────────────
  // ENTRADAS Y SALIDAS
  // ────────────────────────────────────────────────────────────────────────────
   ...
   */
  private detalleOriginal: CategoriaTortaDetalleDTO | null = null;
  ...
  get tituloModal(): string {
    return this.esEditar ? 'Editar Categoria de Torta' : 'Nueva Categoria de Torta';
  }
  ...
  onSubmit(): void {
    ...
    const operacion$ = this.esEditar ? this.categoriaTortaService.modificar(
          this.inputData.id!,
          datosForm,
          this.detalleOriginal!,
        ) : this.categoriaTortaService.insertar(datosForm);
