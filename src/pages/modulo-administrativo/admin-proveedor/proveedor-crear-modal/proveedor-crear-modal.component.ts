/**
 * @file proveedor-crear-modal.component.ts
 * @description Modal para crear un nuevo proveedor con búsqueda SUNAT
 */
...
import { ProveedorRequestDTO } from '../../../../models/entrada-insumo-dto';
...
@Component({
  selector: 'app-proveedor-crear-modal',
  standalone: true,
...
export class ProveedorCrearModalComponent {
  ...
  guardar() {
    ...
    this.proveedorSvc.crear(data).subscribe({
      next: () => {
